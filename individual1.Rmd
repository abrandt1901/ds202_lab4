...
Purdy performs above average compared to the rest of the players. For example her has a mean if 2.077 passing touchdowns where as the team as a mean of 0.935 passing touchdowns.
...
offComp <- inner_join(offense, offense2, by='Name')
defComp <- inner_join(defense, defense2, by='Name')
offComp
defComp
#ggplot(offComp, aes(x=`Recorded.x`, y = `Recorded.y`)) + geom_point() + xlab('Iowa') + ylab('Notre Dame') + ggtitle("Solo Tackles against Iowa vs. Solo Tackles against Notre Dame")
```
